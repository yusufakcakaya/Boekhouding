...
class User(UserMixin):
    ...
    def __init__(self, id, username, password_hash, role, email=None):
        ...
        self.role = role
        self.email = email  # E-mail artık tam destekli
    ...
    def generate_reset_token(user_id):
        ...
        tokens[token] = {
            "user_id": user_id,
            "expires": time.time() + 3600   # 1 saat geçerli
        }
        _save_tokens(tokens)
        return token
